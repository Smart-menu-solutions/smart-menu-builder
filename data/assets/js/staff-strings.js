...
window.STAFF_STRINGS = {
	de: {
		...
		posTitle: 'Für die Kasse', posNoNumber: 'ohne Kassen-Nr.', posFood: 'Speisen (Küche)', posDrinks: 'Getränke (Bar)', posTotal: 'Gesamt', 
		...
		closeConfirm: 'Tisch wirklich schließen? Das entfernt die Bestellung aus allen Ansichten.',
			...
			guide: {
				...
				cashier: [
					...
					"Smart QuickPay™: Rechts neben der Bestellung steht „Für die Kasse“. Die Kassen-Nummern (z. B. 105 × 2) tippst du einfach in eure Kasse, die Kasse erstellt die Rechnung. Gerichte ohne Nummer stehen mit Betrag darunter, dazu die Summen für Speisen und Getränke. Die Nummern trägt der Admin bei jedem Gericht im Feld „Kassen-Nr.“ ein."
				]
			},
	...
	en: {
		...
		posTitle: 'For the till', posNoNumber: 'no till no.', posFood: 'Food (kitchen)', posDrinks: 'Drinks (bar)', posTotal: 'Total', 
		...
		closeConfirm: 'Really close this table? This removes the order from every view.',
			...
			guide: {
				...
				cashier: [
					...
					"Smart QuickPay™: next to the order you see “For the till”. Key the till numbers (e.g. 105 × 2) into your own till, which issues the receipt. Dishes without a number are listed with their amount, plus the food and drink subtotals. The numbers are set per dish in the admin (“Till no.” field)."
				]
			},
	...
	el: {
		...
		posTitle: 'Για το ταμείο', posNoNumber: 'χωρίς κωδικό ταμείου', posFood: 'Φαγητά (κουζίνα)', posDrinks: 'Ποτά (μπαρ)', posTotal: 'Σύνολο', 
		...
		closeConfirm: 'Κλείσιμο τραπεζιού; Η παραγγελία θα αφαιρεθεί από όλες τις προβολές.',
			...
			guide: {
				...
				cashier: [
					...
					"Smart QuickPay™: Δίπλα στην παραγγελία εμφανίζεται «Για το ταμείο». Πληκτρολόγησε τους κωδικούς (π.χ. 105 × 2) στο δικό σας ταμείο, που εκδίδει την απόδειξη. Τα πιάτα χωρίς κωδικό εμφανίζονται με το ποσό τους, μαζί με τα σύνολα για φαγητά και ποτά. Οι κωδικοί ορίζονται ανά πιάτο στο admin (πεδίο «Κωδικός ταμείου»)."
				]
			},
	...
	it: {
		...
		posTitle: 'Per la cassa', posNoNumber: 'senza n. cassa', posFood: 'Cibo (cucina)', posDrinks: 'Bevande (bar)', posTotal: 'Totale', 
		...
		closeConfirm: 'Chiudere davvero il tavolo? L’ordine sparirà da tutte le viste.',
			...
			guide: {
				...
				cashier: [
					...
					"Smart QuickPay™: accanto all’ordine trovi «Per la cassa». Digita i numeri (es. 105 × 2) nella vostra cassa, che emette lo scontrino. I piatti senza numero sono elencati con l’importo, insieme ai totali di cibo e bevande. I numeri si inseriscono per ogni piatto nell’admin (campo «N. cassa»)."
				]
			},
	...
	es: {
		...
		posTitle: 'Para la caja', posNoNumber: 'sin n.º de caja', posFood: 'Comida (cocina)', posDrinks: 'Bebidas (barra)', posTotal: 'Total', 
		...
		closeConfirm: '¿Cerrar esta mesa de verdad? El pedido desaparecerá de todas las vistas.',
			...
			guide: {
				...
				cashier: [
					...
					"Smart QuickPay™: junto al pedido aparece «Para la caja». Teclea los números (p. ej. 105 × 2) en vuestra caja, que emite el ticket. Los platos sin número aparecen con su importe, junto con los subtotales de comida y bebidas. Los números se asignan a cada plato en el admin (campo «N.º de caja»)."
				]
			},
	...
	fr: {
		...
		posTitle: 'Pour la caisse', posNoNumber: 'sans n° de caisse', posFood: 'Plats (cuisine)', posDrinks: 'Boissons (bar)', posTotal: 'Total', 
		...
		closeConfirm: 'Vraiment fermer cette table ? La commande disparaîtra de toutes les vues.',
			...
			guide: {
				...
				cashier: [
					...
					"Smart QuickPay™ : à côté de la commande figure « Pour la caisse ». Saisissez les numéros (ex. 105 × 2) dans votre caisse, qui édite le ticket. Les plats sans numéro sont listés avec leur montant, avec les sous-totaux plats et boissons. Les numéros se renseignent par plat dans l’admin (champ « N° de caisse »)."
				]
			},
