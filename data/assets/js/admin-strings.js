...
window.ADMIN_STRINGS = {
	de: {
		...
		tablesEmailPreparing: 'QR-Codes mit Tischnummer werden erstellt …', couldNotCreateTableQr: 'QR-Bilder konnten nicht erstellt werden: {error}',
	...
	en: {
		...
		tablesEmailPreparing: 'Creating QR codes with table numbers …', couldNotCreateTableQr: 'Could not create the QR images: {error}',
